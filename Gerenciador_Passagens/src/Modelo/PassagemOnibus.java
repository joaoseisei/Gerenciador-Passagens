...
/**
 * A classe passagemOnibus é herdada da classe passagens, que por sua vez tem um
 * itinerario. Sendo assim, nessa classe temos todos os itens a cima mais 4
 * atributos que definem uma passagem de ônibus.
 * 
 * @author joaoseisei
 * @since 2023
 * @version 1.3
...
//CONSTRUTOR
	...
	/**
	 * Esse construtor é responsável por adicionar todos os atributos de uma
	 * passagem de ônibus, isso ocorre pois é importante criar uma passagem de
	 * ônibus com todos as informações definidas. Além disso existe um setter
	 * automático de numParadas através do setter "setHorarioENumParadas".
	 * 
	 * @param itinerario
	 * @param escalas
	 * @param preco
	 ...
	 */
	public PassagemOnibus(Itinerario itinerario, String[] escalas, Double preco, String marca, Boolean leito,
			String[] horarioParadas, Boolean refeicaoInclusa) {
		// SUPER
...
//SETTERS
	...
	/**
	 * Esse método é responsável por definir o número de paradas automaticamente
	 * sempre que for adicionado ou removido uma parada da lista de escalas
	 * "paradas".
	 * 
	...
	public void setHorarioENumParadas(String[] novoHorarioParadas) {
		...
		if (novoHorarioParadas == null)
			this.numParadas = 0;
		else
			this.numParadas = novoHorarioParadas.length;
	}
...
//METODO ABSTRATO
	/**
	 * Esse método é herdado da classe passagem e é modificado para calcular o preço
	 * de acordo com o número de escalas, ou se o ônibus é leito ou nao, esse método
	 * nunca irá retornar algo menor que 0.00.
	 * 
...
//TOSTRING	
	...
	public String toString() {
		...
		return super.toString()
				// TOSTRING ONIBUS
				+ "\n  Tipo: Onibus" + " | Marca: " + getMarca() + " (ÔNIBUS)" + " | Onibus leito: " + leito
				+ " | Preço: " + calculaPreco() + "\n  Numero de paradas: " + numParadas + " | Horario das Paradas: "
				+ Arrays.toString(horarioParadas) + " | Refeicao Inclusa: " + refeicaoInclusa;
