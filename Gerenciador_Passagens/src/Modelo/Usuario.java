...
/**
 * A classe Usuario é uma extensão da classe Conta, nela tem uma lista de
 * favoritos, para salvar as preferências do usuario.
 * 
 * @author joaoseisei
 * @since 2023
 * @version 1.3
...
//CONSTRUTOR
	/**
	 * Construtor para inicialziar as variaveis da classe e é herdada da classe mãe
	 * Conta. Sendo assim, o nome e senha já estão sendo tratados.
	 * 
...
//ADICIONANDO FAVORITOS
	/**
	 * O método addFavoritos é responsavel por adicionar uma String no atributo
	 * "listaFavoritos".
	 * 
