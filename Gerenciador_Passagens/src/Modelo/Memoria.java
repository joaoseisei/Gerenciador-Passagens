...
/**
 * A classe memoria é responsavel por armazenar todos os dados do projeto em
 * ArrayLists.
 * 
 * @author joaoseisei
 * @since 2023
...
//GETTERS	
	...
	/**
	 * O método getAdminOBJ é responsável por buscar um admin na lista de admin e
	 * retornar o objeto dele.
	 * 
	 * @param nome  Nome do admin a ser buscado.
	 * @param senha Senha do admin a ser buscado.
	 * @return Retorna o objeto admin encontrado e se nao encontrar nenhum
	...
	/**
	 * O método getUsuarioOBJ é responsável por buscar um usuario na lista de
	 * usuarios e retornar o objeto dele.
	 * 
	 * @param nome  Nome do usuário a ser buscado.
	 * 
	 * @param senha Senha do usuário a ser buscado.
	 * @return Retorna o objeto usuário encontrado se não encontrar nenhum
	 *         correspondente retorna null.
	 */
