...
public class TesteUnitario {
	...
	void testAddItinerario() {
		tla.addItinerario(LocalDate.of(2023, 12, 04), LocalDate.of(2023, 12, 05), LocalTime.of(14, 0),
	...
	void testEditarItinerario() {
		...
		tla.editItinerario(it.getIdItinerario(), LocalDate.of(2024, 12, 12), LocalDate.of(2024, 12, 13),
				LocalTime.of(11, 11), LocalTime.of(22, 22), "TESTE", "TESTE2");
